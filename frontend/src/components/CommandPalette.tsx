...
const NAV_COMMANDS: CommandItem[] = [
  {
    key: "nav-dashboard",
    label: "AI 驾驶舱 Command Center",
    icon: <DashboardOutlined />,
    group: "导航",
    path: "/dashboard",
    keywords: "home overview 首页 dashboard",
  },
  {
    key: "nav-traces",
    ...
    group: "导航",
    path: "/traces",
    keywords: "trace langsmith 轨迹",
  },
  {
    key: "nav-diagnosis",
    label: "故障诊断 Diagnosis",
    icon: <ExperimentOutlined />,
    group: "导航",
    path: "/diagnosis",
    keywords: "diagnosis failure 故障",
  },
  {
    key: "nav-analytics",
    label: "分析 Analytics",
    ...
    group: "导航",
    path: "/analytics",
    keywords: "analytics radar 分析",
  },
  {
    key: "nav-monitoring",
    label: "实时监控 Monitoring",
    icon: <DashboardOutlined />,
    group: "导航",
    path: "/monitoring",
    keywords: "monitor k8s health 监控",
  },
  {
    key: "nav-tasks",
    label: "任务列表",
  ...
  },
  {
    ...
    group: "导航",
    path: "/billing",
    keywords: "billing usage quota 计费 用量 配额",
  },
  {
    key: "nav-settings",
    label: "设置",
