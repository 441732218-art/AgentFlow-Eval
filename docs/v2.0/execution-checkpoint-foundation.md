...
- `plan_id`
- `step_id`
- `state_snapshot` — runtime recovery payload such as task, status, and completed steps
- `created_at`
- `metadata` — checkpoint phase markers such as `before_step` or `execution_completed`
