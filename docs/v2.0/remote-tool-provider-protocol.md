...
**Phase:** 8.2.3 — Remote Tool Executor Adapter + Tool Provider Protocol Skeleton  
**Date:** 2026-08-31
...
| External error → Runtime error mapping | `errors.py` |
...
"remote" → RemoteToolExecutorAdapter
```
